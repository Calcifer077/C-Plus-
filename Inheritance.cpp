/*
Inheritance ->can be used for using a particular class methods and memebers in another class.
...
In this type there is more than one level of inheritance like a family of three or more genrations.
